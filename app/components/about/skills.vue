...
<template>
  <div class="my-10">
    ...
    <SkillSection :title="t('about.skills.sections.designTools')" title-icon="line-md:pencil" :items="designTools" />
    <SkillSection :title="t('about.skills.sections.cmsTools')" title-icon="line-md:computer" :items="cmsTools" />
  </div>
</template>
