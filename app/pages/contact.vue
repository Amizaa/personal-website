...
useHead({
    title: 'Amirreza Noruzi | Contact Me'
})
</script>
...
<template>
    <div class="my-10">
        <div class="my-10 p-3">
            ...
            <p class="my-2 text-gray-600 dark:text-gray-300 text-center">Let’s connect — whether it’s about projects, collaborations, or just sharing ideas.</p>
